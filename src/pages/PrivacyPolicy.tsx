        ...
        <div className="container-custom">
          ...
          <div className="prose max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-navy-800 mb-4">1. Introdução</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-navy-800 mb-4">2. Dados que Recolhemos</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-navy-800 mb-4">3. Finalidade da Recolha</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-navy-800 mb-4">4. Não Utilização de Cookies</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-navy-800 mb-4">5. Partilha de Dados</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-navy-800 mb-4">6. Contacto</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-navy-800 mb-4">7. Atualizações à Política de Privacidade</h2>
              <p className="text-gray-700 mb-4">
