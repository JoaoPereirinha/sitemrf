              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="bg-navy-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Procuramos colaborador(a) administrativo(a) organizado(a) e eficiente para apoiar as operações
                    diárias da nossa empresa. Esta função é fundamental para garantir o bom funcionamento dos processos administrativos.
                  </p>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      'Atendimento telefónico e email',
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      ...
                      { icon: <Award className="w-6 h-6" />, text: 'Oportunidades de desenvolvimento' },
...
export default JobAdministrativo;
