              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="bg-navy-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Procuramos motorista responsável e pontual para integrar a nossa equipa de distribuição.
                    Esta posição é essencial para garantir a entrega atempada de materiais de construção aos nossos clientes.
                  </p>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    {[
                      'Carta de condução categoria C ou superior',
                      'Experiência comprovada em condução de veículos pesados',
                      'Certificado de Aptidão de Motorista (CAM) atualizado',
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      ...
                      { icon: <TrendingUp className="w-6 h-6" />, text: 'Remuneração competitiva' },
                      { icon: <Users className="w-6 h-6" />, text: 'Ambiente de trabalho familiar' },
                      { icon: <Clock className="w-6 h-6" />, text: 'Horário de trabalho regular' },
                      { icon: <Award className="w-6 h-6" />, text: 'Formação inicial' },
