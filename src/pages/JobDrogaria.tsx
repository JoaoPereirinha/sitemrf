...
const JobDrogaria: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    phone: '',
    position: 'Colaborador(a) para drogaria (Atendimento ao público)',
    experience: '',
    message: '',
              ...
              <div className="lg:col-span-2 space-y-8">
                <div>
                  <h1 className="text-4xl font-bold text-navy-800 mb-4">
                    Colaborador(a) para drogaria (Atendimento ao público)
                  </h1>
                ...
                <div className="bg-navy-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Procuramos um(a) colaborador(a) dinâmico(a) e dedicado(a) para integrar a nossa equipa de atendimento ao público
                    na drogaria MRF. Esta é uma excelente oportunidade para quem gosta de trabalhar com pessoas e deseja fazer
                    parte de uma empresa familiar com mais de 35 anos de experiência no setor.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    Como colaborador(a) de atendimento, será responsável por acolher os nossos clientes, compreender as suas
                    necessidades e ajudá-los a encontrar os produtos adequados para os seus projetos de construção e renovação.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    {[
                      'Atendimento personalizado aos clientes na loja',
                      'Aconselhamento sobre produtos e materiais de construção',
                      'Processamento de vendas e gestão de caixa',
                      'Manutenção da organização e limpeza da área de vendas',
                      'Reposição de produtos nas prateleiras',
                      'Apoio na gestão de stock e inventário',
                      'Resolução de dúvidas e reclamações dos clientes'
                    ].map((item, index) => (
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      ...
                      { icon: <Award className="w-6 h-6" />, text: 'Oportunidades de crescimento' },
